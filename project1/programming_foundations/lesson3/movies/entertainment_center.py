...
breaking_bad_e1_s1 = media.Episode('Pilot',
...
breaking_bad_e2_s1 = media.Episode('Cats in the Bag',
...
breaking_bad = media.TvShow('Breaking bad', 'The secret lifestyle of a chemistry teacher',
							'http://upload.wikimedia.org/wikipedia/commons/4/48/Breaking_Bad_logo.png',
							'AMC',
							[breaking_bad_e1_s1, breaking_bad_e2_s1])


modern_family = media.TvShow('Modern Family', 'A comedy that follows the lives of a peculiar family',
